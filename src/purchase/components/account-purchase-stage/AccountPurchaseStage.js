...
import {FormLayout, RadioWrapper, ActiveRadio, Input, StageButton} from "purchase/components/partials/Partials";
    ...
    <>
      ...
      <SelectReceiptWrapper>
        ...
        <FormLayout
          ...
          borderColor={visibleIndex === 0 ? colorSet.pointColor : colorSet.gray1}
        ...
        <FormLayout
          ...
          className="flex align-center"
          borderColor={visibleIndex === 1 ? colorSet.pointColor : colorSet.gray1}
